...
import { BufferGeometry, MathUtils, MeshPhongMaterial } from "three";
...
export default function Model(props: JSX.IntrinsicElements["group"]) {
  ...
  materials.Natural.color.set("#ffffff");
  materials.Accidental.color.set("#101010");
  ...
  useEffect(() => {
    // Rotates entire group so that we are looking at the keys sitting back
    // from the keyboard, not directly over it
    group.current.rotateX(-1 * 0.75);

    // Compensate for the change in 2D position of the keys from the rotation,
    // putting it back in the center. Not an exact science, but it's fine!
