...
export const Model = forwardRef<Group, GroupProps>((props, ref) => {
  ...
  const keyMeshMap = useMemo<KeyMeshMap>(() => {
    ...
    gltfResult.nodes.A0.geometry.computeBoundingBox();
    const zOffset = gltfResult.nodes.A0.geometry.boundingBox.max.z;
    ...
    for (keyName in gltfResult.nodes) {
      ...
      // keyMesh.translateY(1)
      keyMesh.geometry.translate(0, 0, zOffset);
      // keyMesh.position.z -= keyMesh.geometry.boundingBox.max.z;
    }
